            ...
            <div className="card">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium">{(fund.managementFee / 100).toFixed(1)}% / 年</p>
                </div>
                <div>
                  <p className="text-gray-600">績效費</p>
                  <p className="font-medium">{(fund.performanceFee / 100).toFixed(1)}%</p>
                </div>
                <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">
                      ${(parseFloat(userInvestmentSummary.totalDeposited) - parseFloat(userInvestmentSummary.totalRedeemed)).toFixed(2)}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    可用餘額: {parseFloat(tokenBalance).toFixed(2)} {denominationAsset.symbol}
                  </p>
                </div>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      可贖回份額: {parseFloat(userShares).toFixed(4)}
                    </p>
                  </div>
